...
function draw (){
 ...
 text("Moving rect width="+movingRect.width,200,350);
  text("Fixed rect height="+fixedRect.height,200,410);
  text("Fixed rect width="+fixedRect.width,200,440);
...
function isTouching (obj1,obj2){
  ...
  if (obj2.x-obj1.x<(obj2.width+obj1.width)/2&&obj1.x-obj2.x<(obj1.width+obj2.width)/2
